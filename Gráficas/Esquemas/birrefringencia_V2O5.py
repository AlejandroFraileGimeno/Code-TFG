# -*- coding: utf-8 -*-
"""
Birrefringencia en el plano de V2O5 (potencial como retardador natural).

Delta n = n_A - n_C, Delta kappa = kappa_A - kappa_C (ejes x=A, y=C en la
convención de eps_V2O5), calculados a partir del modelo dieléctrico propio
(eps_A_V2O5_4parOsc, eps_C_V2O5_4parOsc) ya usado en el resto del TFG.
"""
...
# ---------------------------------------------------------------------------
# Cálculo: n, kappa por eje a partir de eps_A_V2O5_4parOsc / eps_C_V2O5_4parOsc
# ---------------------------------------------------------------------------
...
for i, w in enumerate(OMEGA):
    ...
    nx_complex = np.sqrt(eps_x_V2O5(wl))
    ny_complex = np.sqrt(eps_y_V2O5(wl))
...
fig.savefig(out / "birrefringencia_V2O5.png", dpi=300, bbox_inches="tight")
fig.savefig(out / "birrefringencia_V2O5.pdf", bbox_inches="tight")
