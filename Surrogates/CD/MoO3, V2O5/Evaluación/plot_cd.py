"""
Plot CD spectrum for a user-defined configuration (MoO3 / V2O5 bilayer).
...
model_dir   = ROOT_PATH / "Models" / "CD" / "MoO3_V2O5"
...
plt.title(rf"MoO3/V2O5 — $d_1$={d1} nm, $d_2$={d2} nm, $\theta$={theta}°")
plt.legend()
plt.tight_layout()
plt.show()