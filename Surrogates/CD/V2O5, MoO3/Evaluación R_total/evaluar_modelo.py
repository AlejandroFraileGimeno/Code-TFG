"""
Numerical evaluation -- R_total surrogate (V2O5 / MoO3)
"""
...
def evaluate(model_dir, database, num_seeds=5, N=50, alpha=0):
    ...
    for i in range(N):
        ...
        print(f"[{i+1:3d}/{N}] d1={d1:4d} d2={d2:4d} theta={theta:3d} | R2={r2:.4f}  MAE={mae:.6f}  RMSE={rmse:.6f}")
...
if __name__ == "__main__":
    evaluate(
        model_dir=str(ROOT_PATH / "Models" / "R_total" / "V2O5_MoO3"),
