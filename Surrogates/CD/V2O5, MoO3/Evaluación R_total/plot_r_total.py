"""
Plot R_total spectrum for a user-defined configuration (V2O5 / MoO3).
...
model_dir   = ROOT_PATH / "Models" / "R_total" / "V2O5_MoO3"
...
plt.title(f"V2O5/MoO3 -- d1={d1} nm, d2={d2} nm, theta={theta} deg")
plt.legend()
plt.tight_layout()
plt.show()