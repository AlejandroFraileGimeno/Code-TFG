"""
===========================================================
Prediction — R_total surrogate vs TMM
===========================================================
Genera N configuraciones aleatorias, compara R_total predicho
por la NN con el calculado por TMM y guarda las gráficas.
...
def run_inference(model_dir, database, num_seeds=1, N_pred=5, alpha=0):
    t1 = time.time()
    ...
    for i in range(N_pred):
        ...
        print(f"\nConfiguración {i+1}: d1={d1} nm  d2={d2} nm  θ={theta}°")
        ...
        ax.set_title(rf"$d_1$={d1} nm  $d_2$={d2} nm  $\theta$={theta}°")
        ax.legend()
        fig.tight_layout()
