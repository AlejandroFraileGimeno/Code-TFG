...
"""
===========================================================
Training — R_total surrogate (MgTeMoO6 / MgTeMoO6)
===========================================================
...
def train_models(
    directory: str = "./Models_Trained_R_total_MgTeMoO6/",
    database: str = "./Database_MgTeMoO6_MgTeMoO6",
    ntrain: int = 800,
    nvalidation: int = 200,
    ...
    xtr, xva, ytr, yva, scalers = auxf.prepare_data(
        ntrain, nvalidation, database, return_scalers=True,
    ...
    num_simulations = 5
    list_simulations = list(range(num_simulations))
        ...
        r = model.fit(
            ...
            callbacks=[
                tf.keras.callbacks.EarlyStopping(
                    ...
                    patience=20, mode="min", restore_best_weights=True,
                )
