"""
Plot CD spectrum for a user-defined configuration (MoO3 / MgTeMoO6).
...
model_dir   = ROOT_PATH / "Models" / "CD" / "MoO3_MgTeMoO6"
...
plt.title(f"MoO3/MgTeMoO6 — d1={d1} nm, d2={d2} nm, theta={theta} deg")
plt.legend()
plt.tight_layout()
plt.show()