"""
Plot R_total spectrum for a user-defined configuration (V2O5 / MgTeMoO6).
...
model_dir   = ROOT_PATH / "Models" / "R_total" / "V2O5_MgTeMoO6"
...
plt.title(f"V2O5/MgTeMoO6 -- d1={d1} nm, d2={d2} nm, theta={theta} deg")
plt.legend()
plt.tight_layout()
plt.show()