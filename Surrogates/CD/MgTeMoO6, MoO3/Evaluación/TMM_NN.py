"""
Prediction — CD_norm surrogate vs TMM (MgTeMoO6 / MoO3)
"""
...
def run_inference(model_dir, database, num_seeds=5, N_pred=5, alpha=0):
    ...
    for i in range(N_pred):
        ...
        ax.set_title(f"MgTeMoO6/MoO3 -- d1={d1} nm  d2={d2} nm  theta={theta} deg")
        ax.legend()
        fig.tight_layout()
...
if __name__ == "__main__":
    run_inference(
        model_dir=str(ROOT_PATH / "Models" / "CD" / "MgTeMoO6_MoO3"),
        database=str(ROOT_PATH / "Datasets" / "CD" / "MgTeMoO6_MoO3"),
