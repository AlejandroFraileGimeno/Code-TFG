"""
===========================================================
Plot R_total spectrum for a user-defined configuration (V2O5 / V2O5)
===========================================================
...
model_dir   = ROOT_PATH / "Models" / "R_total" / "V2O5_V2O5"
...
plt.title(rf"V2O5/V2O5 — $d_1$={d1} nm, $d_2$={d2} nm, $\theta$={theta}°")
plt.legend()
plt.tight_layout()
plt.show()