"""
Plot R_total spectrum for a user-defined configuration (MgTeMoO6 / V2O5).
...
model_dir   = ROOT_PATH / "Models" / "R_total" / "MgTeMoO6_V2O5"
...
plt.title(f"MgTeMoO6/V2O5 -- d1={d1} nm, d2={d2} nm, theta={theta} deg")
plt.legend()
plt.tight_layout()
plt.show()