...
"""
===========================================================
data_generation  — MoO3 / V2O5 bilayer
===========================================================
- angles.csv          -> (n_estructuras, 1)  theta en grados
- thickness.csv       -> (n_estructuras, 2)  [d1, d2] en nm
- CD_spectra_norm.csv -> (n_estructuras, n_freqs) |CD_norm|
- R_total_spectra.csv -> (n_estructuras, n_freqs) R_total = R_r + R_l

Estructura: [ MoO3(d1, phi=theta), V2O5(d2, phi=0) ]
"""
