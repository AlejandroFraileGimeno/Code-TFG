# -*- coding: utf-8 -*-
"""
Entrenamiento de la red forward espectral — T_xx  MoO3/V2O5/BaF2

Dataset esperado en Datasets/T_xx/MoO3_V2O5_BaF2/:
...
Modelo guardado en Models/T_xx/MoO3_V2O5_BaF2/Forward/
  forward.keras
  scalers.json       — min/max de cada parámetro de entrada
  history_loss.txt
"""
...
LR           = 1e-3
PATIENCE     = 25
NUM_SEEDS    = 3     # modelos con semillas distintas (ensemble)
# ============================================================
...
# ---------------------------------------------------------------------------
# Normalización de entradas: min-max → [0, 1]
# ---------------------------------------------------------------------------
param_min = params.min(axis=0)   # (4,)
param_max = params.max(axis=0)   # (4,)
...
# ---------------------------------------------------------------------------
# Entrenamiento (ensemble de NUM_SEEDS modelos)
# ---------------------------------------------------------------------------
