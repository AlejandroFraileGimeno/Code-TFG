# -*- coding: utf-8 -*-
"""
Barrido de stop-bands -- diseno inverso T_xx  MoO3/V2O5/BaF2
============================================================
Para cada combinacion (left, right, A_pct, flank) construye el objetivo:

    T ~ A_pct/100  fuera de la banda
    T ~ 0          dentro de la banda
...
Ejes barridos:
  ...
  A_pct  : transmitancia fuera      [50,60,70,80,90,100] %
...
Salidas por cada valor de A_pct:
  ...
  resultados/ejemplos_buenos.png            -- mejores 6 casos
  resultados/ejemplos_malos.png             -- peores 6 casos
...
plot_ejemplos(casos_buenos,
              "Mejores 6 stop-bands [MoO3/V2O5/BaF2] (eval: forward NN)",
              "ejemplos_buenos.png")
plot_ejemplos(casos_malos,
              "Peores 6 stop-bands [MoO3/V2O5/BaF2] (eval: forward NN)",
              "ejemplos_malos.png")
