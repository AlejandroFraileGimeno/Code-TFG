# -*- coding: utf-8 -*-
"""
Barrido de stop-bands -- VERSION BATCH -- diseno inverso T_xx  MoO3/V2O5/BaF2
===============================================================================
...
for ka, a_pct in enumerate(A_PCT_LIST):
    ...
    fig.suptitle(
        f"Stop-band sweep -- T_outside={a_pct}%  T_inside=0  [MoO3/V2O5/BaF2]  EVAL={EVAL_MODE}",
        fontsize=12)
    fig.tight_layout()
...
plot_ejemplos(casos_buenos, "Mejores 6 stop-bands [MoO3/V2O5/BaF2] (eval: forward NN)", "ejemplos_buenos.png")
plot_ejemplos(casos_malos,  "Peores 6 stop-bands [MoO3/V2O5/BaF2] (eval: forward NN)",  "ejemplos_malos.png")
