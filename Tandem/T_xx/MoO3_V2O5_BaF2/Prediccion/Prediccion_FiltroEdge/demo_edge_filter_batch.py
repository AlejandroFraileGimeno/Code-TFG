...
for filter_name, combos, tc_offset in [
    ...
    fig.savefig(ARREGLOS / f"heatmap_edge_{filter_name}_MoO3_V2O5.png", dpi=200, bbox_inches="tight")
...
for filter_name in ("highpass",):
    ...
    figm.tight_layout()
    figm.savefig(ARREGLOS / f"mejor_caso_edge_{filter_name}_MoO3_V2O5.png", dpi=200, bbox_inches="tight")
    print(f"Guardado: mejor_caso_edge_{filter_name}_MoO3_V2O5.png")
