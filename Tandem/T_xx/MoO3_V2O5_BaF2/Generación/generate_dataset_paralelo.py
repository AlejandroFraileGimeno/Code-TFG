# -*- coding: utf-8 -*-
"""
Generación PARALELA de dataset para red tandem — T_xx  MoO3/V2O5/BaF2
=======================================================================
...
if __name__ == "__main__":
    ...
    print(f"Generación paralela T_xx — MoO3/V2O5/BaF2")
    ...
    with ProcessPoolExecutor(max_workers=N_WORKERS) as executor:
        ...
        for future in as_completed(futures):
            ...
            if n_done is None:
                print(f"  [{completed:4d}/{n_chunks}]  chunk {chunk_idx:05d} -> ya existía")
            else:
