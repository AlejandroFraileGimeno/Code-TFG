# -*- coding: utf-8 -*-
"""
Red inversa para diseno inverso de T_xx — V2O5/MoO3/BaF2

Entrada : T_xx(f)  ->  espectro objetivo  (N_FREQS valores en [0,1])
Salida  : (theta1, theta2, d1, d2)  normalizado a [0,1]  ->  4 valores

Activacion sigmoid en la salida: los 4 parametros quedan en [0,1]
y se desnormalizan con scalers.json del Forward.
"""
