# -*- coding: utf-8 -*-
"""
Entrenamiento de la red forward espectral — T_xx  V2O5/MoO3/BaF2

Dataset esperado en Datasets/T_xx/V2O5_MoO3_BaF2/:
...
Modelo guardado en Models/T_xx/V2O5_MoO3_BaF2/Forward/
  forward.keras
  scalers.json       — min/max de cada parametro de entrada
  history_loss.txt
"""
...
# ---------------------------------------------------------------------------
# Normalizacion de entradas: min-max -> [0, 1]
# ---------------------------------------------------------------------------
