# -*- coding: utf-8 -*-
"""
Generación PARALELA de dataset para red tandem — T_xx  V2O5/MoO3/BaF2
=======================================================================
...
OUTPUT_DIR = ROOT_PATH / "Datasets" / "T_xx" / "V2O5_MoO3_BaF2"
...
if __name__ == "__main__":
    ...
    print(f"Generación paralela T_xx — V2O5/MoO3/BaF2")
