# -*- coding: utf-8 -*-
"""
Generacion PARALELA de dataset para red tandem — T_xx  MoO3/MoO3/BaF2
=======================================================================
...
OUTPUT_DIR = ROOT_PATH / "Datasets" / "T_xx" / "MoO3_MoO3_BaF2"
...
def _compute_chunk(chunk_idx: int, theta1s, theta2s, d1s, d2s, freqs):
    ...
    for i in range(n):
        ...
        structure = LayeredStructure(
            ...
            substrate=BaF2(),
            layers=[
                MoO3(d=d1s[i] * 1e-9, phi=phi1),
                MoO3(d=d2s[i] * 1e-9, phi=phi2),
            ],
        )
...
if __name__ == "__main__":
    ...
    print(f"Generacion paralela T_xx — MoO3/MoO3/BaF2")
