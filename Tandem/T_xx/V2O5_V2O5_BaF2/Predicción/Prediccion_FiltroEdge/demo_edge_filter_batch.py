# -*- coding: utf-8 -*-
"""
Barrido de filtros de borde -- VERSION BATCH -- T_xx  V2O5/V2O5/BaF2
======================================================================
...
T_COMBOS_HP = [(0.0, 1.0), (0.025, 0.95), (0.050, 0.9)]
...
for filter_name, combos, tc_offset in [
    ...
    fig.savefig(ARREGLOS / f"heatmap_edge_{filter_name}_V2O5_V2O5.png", dpi=200, bbox_inches="tight")
...
for filter_name in ("highpass",):
    ...
    figm.tight_layout()
    figm.savefig(ARREGLOS / f"mejor_caso_edge_{filter_name}_V2O5_V2O5.png", dpi=200, bbox_inches="tight")
    print(f"Guardado: mejor_caso_edge_{filter_name}_V2O5_V2O5.png")

    plot_ejemplos(buenos, f"Mejores 6 -- filtro {label} [V2O5/V2O5/BaF2]", f"ejemplos_buenos_{filter_name}.png")
    plot_ejemplos(malos,  f"Peores 6  -- filtro {label} [V2O5/V2O5/BaF2]", f"ejemplos_malos_{filter_name}.png")
