# -*- coding: utf-8 -*-
"""
Barrido de dips gaussianos -- diseno inverso T_xx  V2O5/V2O5/BaF2
===================================================================
Version batch: todas las predicciones se hacen de una sola vez.
...
all_targets = np.stack([make_target(f0, sig)
                        for f0, sig in zip(valid_f0, valid_sig)])
...
ax.set_title(
    f"Calidad ajuste inverso -- dip gaussiano  [V2O5/V2O5/BaF2]\n"
...
plot_ejemplos(casos_buenos, "Mejores 6 -- dip gaussiano [V2O5/V2O5/BaF2] (eval: forward NN)", "ejemplos_buenos.png")
plot_ejemplos(casos_malos,  "Peores 6  -- dip gaussiano [V2O5/V2O5/BaF2] (eval: forward NN)", "ejemplos_malos.png")
