# -*- coding: utf-8 -*-
"""
Barrido de filtros de borde -- VERSION BATCH -- T_xx  MgTeMoO6/MgTeMoO6/BaF2
===============================================================================
...
for filter_name, combos, tc_offset in [
    ...
    fig.suptitle(f"Filtro de borde -- {label}  [MgTeMoO6/MgTeMoO6/BaF2]  EVAL={EVAL_MODE}", fontsize=12)
    fig.tight_layout()
...
for filter_name in ("highpass",):
    ...
    plot_ejemplos(buenos, f"Mejores 6 -- filtro {label} [MgTeMoO6/MgTeMoO6/BaF2]", f"ejemplos_buenos_{filter_name}.png")
    plot_ejemplos(malos,  f"Peores 6  -- filtro {label} [MgTeMoO6/MgTeMoO6/BaF2]", f"ejemplos_malos_{filter_name}.png")
