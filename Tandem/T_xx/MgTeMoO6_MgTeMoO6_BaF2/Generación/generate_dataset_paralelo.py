# -*- coding: utf-8 -*-
"""
Generacion PARALELA de dataset para red tandem — T_xx  MgTeMoO6/MgTeMoO6/BaF2
===============================================================================
Divide N_SAMPLES en chunks y procesa cada chunk en un worker independiente.
Checkpointing: si un chunk_XXXX.npz ya existe en tmp/, lo salta.
"""
...
OUTPUT_DIR = ROOT_PATH / "Datasets" / "T_xx" / "MgTeMoO6_MgTeMoO6_BaF2"
...
def _compute_chunk(chunk_idx: int, theta1s, theta2s, d1s, d2s, freqs):
    ...
    for i in range(n):
        ...
        structure = LayeredStructure(
            ...
            substrate=BaF2(),
            layers=[
                MgTeMoO6(d=d1s[i] * 1e-9, phi=phi1),
                MgTeMoO6(d=d2s[i] * 1e-9, phi=phi2),
            ],
        )
...
if __name__ == "__main__":
    ...
    print(f"Generacion paralela T_xx — MgTeMoO6/MgTeMoO6/BaF2")
