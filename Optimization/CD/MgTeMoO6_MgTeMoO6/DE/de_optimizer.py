...
"""
===========================================================
Differential Evolution — CD optimizer (NN surrogate) — MgTeMoO6 / MgTeMoO6
===========================================================
FoM = C1 x CD_norm_peak + C2 x R_total_at_peak

Estructura: Air / MgTeMoO6(d1, phi=theta) / MgTeMoO6(d2) / Au
...
print("=" * 60)
print("  Differential Evolution (surrogate NN) — MgTeMoO6/MgTeMoO6")
print("=" * 60)
...
fig.suptitle(
    f"DE optimo MgTeMoO6/MgTeMoO6 — th={theta_best:.1f} deg   d1={d1_best:.0f} nm   d2={d2_best:.0f} nm\n"
