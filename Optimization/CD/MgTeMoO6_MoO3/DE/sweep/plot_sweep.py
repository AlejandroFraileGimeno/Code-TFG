# -*- coding: utf-8 -*-
"""
Visualizacion del barrido DE — MgTeMoO6/MoO3
"""
...
ax1.set_title("Barrido DE - MgTeMoO6/MoO3   |CD| optimo", fontsize=13)
...
fig2.suptitle("Parametros optimos por target - MgTeMoO6/MoO3", fontsize=13)
fig2.tight_layout()
