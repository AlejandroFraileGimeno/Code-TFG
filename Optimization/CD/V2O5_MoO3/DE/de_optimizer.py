...
"""
===========================================================
Differential Evolution -- CD optimizer (NN surrogate) -- V2O5 / MoO3
===========================================================
FoM = C1 x CD_norm_peak + C2 x R_total_at_peak

Estructura: Air / V2O5(d1, phi=theta) / MoO3(d2) / Au
"""
...
sys.path.insert(0, str(ROOT_PATH / "Surrogates" / "CD" / "V2O5_MoO3"))

from generalized_transfer_matrix_method import (
    Air, Au, V2O5, MoO3, LayeredStructure, calculate_circular_dichroism_ref,
)
...
_CD_MODEL_DIR = ROOT_PATH / "Models" / "CD"      / "V2O5_MoO3"
_RT_MODEL_DIR = ROOT_PATH / "Models" / "R_total" / "V2O5_MoO3"
_DATABASE     = str(ROOT_PATH / "Datasets" / "CD" / "V2O5_MoO3")
...
print("=" * 60)
print("  Differential Evolution (surrogate NN) -- V2O5/MoO3")
print("=" * 60)
