# -*- coding: utf-8 -*-
"""
Visualizacion del barrido DE — V2O5/MoO3
"""
...
im   = ax1.pcolormesh(freqs, targets_cm, CD_matrix, cmap="inferno", shading="auto", vmin=0, vmax=vmax)
...
ax1.set_title("Barrido DE - V2O5/MoO3   |CD| optimo", fontsize=13)
...
axes[1].plot(targets_cm, d1s, "o-", ms=3, color="tab:orange", lw=1, label="d1 (V2O5, rotada)")
axes[1].set_ylabel("d1 (nm)", fontsize=12)
axes[1].grid(True, alpha=0.3)
axes[1].legend(fontsize=10)
axes[2].plot(targets_cm, d2s, "o-", ms=3, color="tab:green", lw=1, label="d2 (MoO3)")
...
fig2.suptitle("Parametros optimos por target - V2O5/MoO3", fontsize=13)
fig2.tight_layout()
