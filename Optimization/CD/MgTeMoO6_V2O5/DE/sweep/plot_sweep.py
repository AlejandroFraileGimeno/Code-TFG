# -*- coding: utf-8 -*-
"""
Visualizacion del barrido DE — MgTeMoO6/V2O5
"""
...
ax1.set_title("Barrido DE - MgTeMoO6/V2O5   |CD| optimo", fontsize=13)
...
axes[2].plot(targets_cm, d2s, "o-", ms=3, color="tab:green", lw=1, label="d2 (V2O5)")
...
fig2.suptitle("Parametros optimos por target - MgTeMoO6/V2O5", fontsize=13)
fig2.tight_layout()
