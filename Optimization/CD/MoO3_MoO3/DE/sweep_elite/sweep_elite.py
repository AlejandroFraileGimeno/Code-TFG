# -*- coding: utf-8 -*-
"""
Barrido DE elite — MoO3/MoO3
Versión más exigente que sweep.py: paso más fino y DE más ambicioso.
Los resultados van a su propia carpeta results/ — no machaca sweep normal.
...
print(f"Barrido elite: {n_total} targets  ({SWEEP_MIN:.0f}-{SWEEP_MAX:.0f} cm-1, paso {FREQ_STEP} cm-1)")
