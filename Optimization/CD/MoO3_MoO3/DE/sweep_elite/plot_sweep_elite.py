...
ax1.set_title("Barrido DE elite — MoO3/MoO3   |CD| óptimo", fontsize=13)
...
axes[1].plot(targets_cm, d1s, "o-", ms=3, color="tab:orange", lw=1, label="d₁ MoO3 (rotada)")
axes[1].set_ylabel("d₁ (nm)", fontsize=12)
axes[1].grid(True, alpha=0.3)
axes[1].legend(fontsize=10)

axes[2].plot(targets_cm, d2s, "o-", ms=3, color="tab:green", lw=1, label="d₂ MoO3")
...
fig2.suptitle("Parámetros óptimos por target — MoO3/MoO3 elite", fontsize=13)
fig2.tight_layout()
