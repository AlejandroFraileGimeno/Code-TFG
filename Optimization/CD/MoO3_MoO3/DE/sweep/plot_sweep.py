# -*- coding: utf-8 -*-
"""
Visualización del barrido DE — MoO3/MoO3
...
freqs       = data[0]["freqs"]
CD_matrix   = np.array([d["CD_tmm"]      for d in data])   # (n_targets, n_freqs)
...
# Diagonal target = frecuencia (diseño perfecto)
...
ax1.set_title(r"MoO$_3$/MoO$_3$", fontsize=21, fontweight="bold", pad=10)
...
fig1.savefig(ARREGLOS / "barrido_DE_CD_MoO3_MoO3.png", dpi=200, bbox_inches="tight")
ARREGLOS_TFG = Path(__file__).resolve().parents[5] / "Arreglos en Gráficos"
ARREGLOS_TFG.mkdir(exist_ok=True)
fig1.savefig(ARREGLOS_TFG / "barrido_DE_CD_MoO3_MoO3.png", dpi=200, bbox_inches="tight")
fig1.savefig(ARREGLOS_TFG / "barrido_DE_CD_MoO3_MoO3.pdf", bbox_inches="tight")
...
axes[1].plot(targets_cm, d1s, "o-", ms=3, color="#2a78d6", lw=1.2, label="d₁ (capa 1, rotada)")
axes[1].set_ylabel(r"$d_1$ (nm)")
axes[1].grid(True, alpha=0.3)
axes[1].legend(fontsize=10)

axes[2].plot(targets_cm, d2s, "o-", ms=3, color="#2a78d6", lw=1.2, label="d₂ (capa 2)")
...
fig2.suptitle("Parámetros óptimos por target — MoO3/MoO3", fontsize=13)
fig2.tight_layout()
