# -*- coding: utf-8 -*-
"""
Visualizacion del barrido DE — V2O5/MgTeMoO6
"""
...
ax1.set_title("Barrido DE - V2O5/MgTeMoO6   |CD| optimo", fontsize=13)
...
fig2.suptitle("Parametros optimos por target - V2O5/MgTeMoO6", fontsize=13)
fig2.tight_layout()
