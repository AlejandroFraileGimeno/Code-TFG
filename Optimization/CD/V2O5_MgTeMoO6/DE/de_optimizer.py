...
"""
===========================================================
Differential Evolution -- CD optimizer (NN surrogate) -- V2O5 / MgTeMoO6
===========================================================
FoM = C1 x CD_norm_peak + C2 x R_total_at_peak

Estructura: Air / V2O5(d1, phi=theta) / MgTeMoO6(d2) / Au
"""
...
for i in range(1, NUM_SEEDS + 1):
    ...
    _scalers_cd.append(auxf._load_scalers(_CD_MODEL_DIR / f"Model_{i}seed" / "scalers.json"))
...
for i in range(1, NUM_SEEDS + 1):
    ...
    _scalers_rt.append(auxf._load_scalers(_RT_MODEL_DIR / f"Model_{i}seed" / "scalers.json"))
...
print("=" * 60)
print("  Differential Evolution (surrogate NN) -- V2O5/MgTeMoO6")
print("=" * 60)
...
print(f"  d1 = {d1_best:.1f} nm  (V2O5 rotado)")
print(f"  d2 = {d2_best:.1f} nm  (MgTeMoO6)")
...
structure = LayeredStructure(
    ...
    layers=[
        V2O5(d=d1_best * 1e-9, phi=np.deg2rad(theta_best)),
        MgTeMoO6(d=d2_best * 1e-9),
    ],
)
...
fig.suptitle(
    f"DE optimo V2O5/MgTeMoO6 -- th={theta_best:.1f} deg   d1={d1_best:.0f} nm (V2O5)   d2={d2_best:.0f} nm (MgTeMoO6)\n"
