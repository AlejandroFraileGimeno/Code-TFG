...
"""
===========================================================
Differential Evolution — CD optimizer (NN surrogate) — MoO3 / MgTeMoO6
===========================================================
FoM = C1 x CD_norm_peak + C2 x R_total_at_peak

Estructura: Air / MoO3(d1, phi=theta) / MgTeMoO6(d2) / Au
...
sys.path.insert(0, str(ROOT_PATH / "Surrogates" / "CD" / "MoO3_MgTeMoO6"))
...
_CD_MODEL_DIR = ROOT_PATH / "Models" / "CD"      / "MoO3_MgTeMoO6"
_RT_MODEL_DIR = ROOT_PATH / "Models" / "R_total" / "MoO3_MgTeMoO6"
_DATABASE     = str(ROOT_PATH / "Datasets" / "CD" / "MoO3_MgTeMoO6")
...
print("=" * 60)
print("  Differential Evolution (surrogate NN) -- MoO3/MgTeMoO6")
print("=" * 60)
...
print(f"  d1 = {d1_best:.1f} nm  (MoO3 rotado)")
...
fig.suptitle(
    f"DE optimo MoO3/MgTeMoO6 -- th={theta_best:.1f} deg   d1={d1_best:.0f} nm (MoO3)   d2={d2_best:.0f} nm (MgTeMoO6)\n"
