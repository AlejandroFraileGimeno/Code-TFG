# -*- coding: utf-8 -*-
"""
Visualizacion del barrido DE — MoO3/MgTeMoO6
"""
...
ax1.set_title("Barrido DE - MoO3/MgTeMoO6   |CD| optimo", fontsize=13)
...
axes[1].plot(targets_cm, d1s, "o-", ms=3, color="tab:orange", lw=1, label="d1 (MoO3, rotada)")
...
fig2.suptitle("Parametros optimos por target - MoO3/MgTeMoO6", fontsize=13)
fig2.tight_layout()
