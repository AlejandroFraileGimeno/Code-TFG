...
"""
===========================================================
Differential Evolution — CD optimizer (NN surrogate) — MoO3 / V2O5
===========================================================
FoM = C1 x CD_norm_peak + C2 x R_total_at_peak

Estructura: Air / MoO3(d1, phi=theta) / V2O5(d2) / Au
...
WINDOW_CM            = 10.0    # cm-1 (solo si TARGET_WAVELENGTH_UM no es None)
NUM_SEEDS            = 1
C1                   = 1.0
C2                   = 0.1
MAXITER              = 500
...
sys.path.insert(0, str(ROOT_PATH / "Surrogates" / "CD" / "MoO3_V2O5"))
...
_CD_MODEL_DIR = ROOT_PATH / "Models" / "CD"      / "MoO3_V2O5"
_RT_MODEL_DIR = ROOT_PATH / "Models" / "R_total" / "MoO3_V2O5"
_DATABASE     = str(ROOT_PATH / "Datasets" / "CD" / "MoO3_V2O5")
...
print("=" * 60)
print("  Differential Evolution (surrogate NN) — MoO3/V2O5")
print("=" * 60)
...
print(f"  d1 = {d1_best:.1f} nm  (MoO3)")
print(f"  d2 = {d2_best:.1f} nm  (V2O5)")
...
fig.suptitle(
    f"DE optimo MoO3/V2O5 — th={theta_best:.1f} deg   d1={d1_best:.0f} nm (MoO3)   d2={d2_best:.0f} nm (V2O5)\n"
