...
ax1.set_title(r"V$_2$O$_5$/V$_2$O$_5$", fontsize=21, fontweight="bold", pad=10)
...
fig1.savefig(ARREGLOS / "barrido_DE_CD_V2O5_V2O5.png", dpi=200, bbox_inches="tight")
fig1.savefig(ARREGLOS / "barrido_DE_CD_V2O5_V2O5.pdf", bbox_inches="tight")
